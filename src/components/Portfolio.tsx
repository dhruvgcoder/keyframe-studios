...
const portfolioItems = [
  ...
  { id: 4, category: 'YouTube', title: 'Presentation', image: 'https://images.unsplash.com/photo-1550745165-9bc0b252726a?q=80&w=2070&auto=format&fit=crop', youtubeVideoId: 'fGAymthRfgY', badgeColor: 'bg-gradient-to-r from-pink-500 to-pink-600' },
