...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8 bg-brand-gray-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/3 w-80 h-80 bg-green-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="border-l border-r border-t border-brand-gray-200 px-6 md:px-8 py-16 relative z-10 bg-white/50 backdrop-blur-sm">
        ...
        <SectionTitle 
          ...
          subtitle="Have a project in mind? We'd love to hear about it. Fill out the form below and let's start the conversation."
        />
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="name" className="block text-sm font-semibold text-brand-gray-700 mb-2">Full Name</label>
              <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} required className="w-full bg-white border-2 border-brand-gray-300 rounded-md py-2.5 px-4 text-brand-gray-900 focus:ring-2 focus:ring-transparent focus:border-transparent focus:outline-none transition focus:shadow-[0_0_0_2px_rgba(168,85,247,0.4)] hover:border-purple-300" />
            </div>
            <div>
              <label htmlFor="email" className="block text-sm font-semibold text-brand-gray-700 mb-2">Email Address</label>
          ...
          <div className="mt-6">
            <label htmlFor="service" className="block text-sm font-semibold text-brand-gray-700 mb-2">Service of Interest</label>
          ...
          <div className="mt-6">
            <label htmlFor="message" className="block text-sm font-semibold text-brand-gray-700 mb-2">Project Details</label>
            <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={5} required className="w-full bg-white border-2 border-brand-gray-300 rounded-md py-2.5 px-4 text-brand-gray-900 focus:ring-2 focus:ring-transparent focus:border-transparent focus:outline-none transition focus:shadow-[0_0_0_2px_rgba(236,72,153,0.4)] hover:border-pink-300"></textarea>
          </div>
          <div className="mt-8 text-center">
            <motion.button
              type="submit"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 text-white font-semibold tracking-wider px-8 py-3.5 rounded-md shadow-lg hover:shadow-xl transition-shadow"
